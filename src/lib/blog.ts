export function returnBlog(page:string) {
	...
	return {
		post: {
			title: "Why Korean Fashion Is Trending in 2023",
	...
	return {
		post: {
			title: "Why You Should Get Up Early",
	...
	return {
		post: {
			title: "Vegetables are essential",
			content: '\n' +
	...
	return {
		post: {
			title: "AQUAMAN: A Cinematic Analysis",
